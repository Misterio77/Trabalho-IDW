  ...
  <v-card>
    ...
    >
      <v-card-text>
        <v-container
          fluid
          v-on:keyup.enter="fazerRegistro"
        >
          <v-text-field
            v-model="registroNome"
            autocomplete="name"
            label="Nome Completo"
            color="secondary"
